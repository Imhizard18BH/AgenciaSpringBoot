...
----------------------------------------------------------------------------------------------
-- CREATE tables: turista, tourist_package, reserva, destino

CREATE TABLE
    IF NOT EXISTS public.turista (
...
CREATE TABLE
    IF NOT EXISTS public.reserva (
        ...
        REFERENCES public.turista (id) MATCH SIMPLE ON UPDATE NO ACTION ON DELETE NO ACTION,
